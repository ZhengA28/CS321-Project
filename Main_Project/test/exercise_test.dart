...
void main(){
  ...
  {
    testWidgets(
        'Exercise widget renders correctly with given name and duration', (
    ...
    testWidgets(
        'Exercise play button starts the timer', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Exercise(
    ...
    testWidgets(
        'Exercise pause button pauses the timer', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Exercise(
    ...
    testWidgets('Exercise slide to delete triggers delete callback', (
        WidgetTester tester) async {
    ...
    testWidgets('Exercise slide to complete triggers complete callback', (
        WidgetTester tester) async {
    ...
    testWidgets('Exercise widget displays correct time format', (
        WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    group('DialogueBox Tests', () {
      testWidgets('DialogueBox renders with text and duration fields', (
          WidgetTester tester) async {
      ...
      testWidgets('DialogueBox calls onSave when Save button is pressed', (
          WidgetTester tester) async {
        final textController = TextEditingController();
        final durationController = TextEditingController();
      ...
      testWidgets('DialogueBox calls onCancel when Cancel button is pressed', (
          WidgetTester tester) async {
        final textController = TextEditingController();
        final durationController = TextEditingController();
      ...
      testWidgets(
          'DialogueBox updates text controllers', (WidgetTester tester) async {
        final textController = TextEditingController();
        final durationController = TextEditingController();
        await tester.pumpWidget(
          MaterialApp(
